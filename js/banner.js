;(function (win, $) {
    var banner = function (obj) {
        ...
        this.image.src = _src;
        var _config = this.banner.attr('data-config') ? this.banner.attr('data-config') : '{}';
        ...
        pagesEvent : function () {
            ...
            _this.pages.click(function () {
                if (_this.config.isClick) {
                    ...
                    _this.config.index = _this.pages.index(this);
                    _this.run ();
                    _this.pages.eq(_this.config.index).addClass('current').siblings().removeClass('current');
                }
            })
        },
