$(function(){
        ...
        addshopcart.click(function(){
            ...
            "<table data-key='"+(key+1)+"'>"
                ...
                +"<td><input type='checkbox' class='check' id='check'></td>"
                   +"<td colspan='6' class='shop_name'><label for='check'>白色恋人官方旗舰店</label><img src='img/pro_center08.png' alt=''></td>"
                    +"</tr>"
                    +"<tr>"
    ...
    function subMenuEvent(){
        ...
        var deal_toggle = $(".deal_toggle");
        var service_toggle = $(".service_toggle");
        var packaging_toggle = $(".packaging_toggle");
        subMenu.click(function(){
            $(this).addClass("current").siblings().removeClass("current");
            if(pro_detalis.hasClass("current")){
                prodetalis_toggle.css("display","block").siblings().css("display","none");
            }
            if(comment_details.hasClass("current")){
                comment_toggle.css("display","block").siblings().css("display","none");
            }
            if(deal.hasClass("current")){
                deal_toggle.css("display","block").siblings().css("display","none");
            }
            if(service.hasClass("current")){
                service_toggle.css("display","block").siblings().css("display","none");
            }
            if(packaging.hasClass("current")){
                packaging_toggle.css("display","block").siblings().css("display","none");
            }
        });
    }
